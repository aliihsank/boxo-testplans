...
func runEarlyProvideForCase2(ctx context.Context, runenv *runtime.RunEnv, h host.Host, bstore blockstore.Blockstore, ex exchange.Interface, initCtx *run.InitContext, r *rand.Rand) error {
	client := initCtx.SyncClient
